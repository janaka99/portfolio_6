          ...
          <Sheet >
            ...
            <SheetContent className='bg-black' >
                ...
                <div className="flex flex-col gap-6 h-full justify-center items-center ">
                  <NavLink className='text-3xl' href="#work">Work</NavLink>
                  <NavLink className='text-3xl' href="#experience">Experience</NavLink>
                  <NavLink className='text-3xl' href="#skills">Skills</NavLink>
                  <NavLink className='text-3xl' href="#testimonials">Testimonials</NavLink>
                </div>
            </SheetContent>
          </Sheet>
        </Container>
...
const NavLink = ({href,className,children}:{href:string, className?:string,children:ReactNode}) =>{
    return (
        <Link  href={`${href}`} className={twMerge('capitalize flex items-center text-muted-foreground hover:text-primary transition  duration-150',className)}>{children}</Link>
    )
}